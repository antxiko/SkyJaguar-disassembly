...
**The game is not ours.** *Sky Jaguar* was published by **Konami** for the MSX in 1984;
its catalogue number is **RC-721** and it is 16 KB. All rights over the game
...
The file `src/skyjaguar.asm` is the commented disassembly of the cartridge. It is
...
If you worked on *Sky Jaguar* or hold rights over the game, and you would rather this
